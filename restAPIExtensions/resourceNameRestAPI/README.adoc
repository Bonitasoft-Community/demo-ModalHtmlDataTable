...
The project **resourceNameRestAPI** is a Bonita REST API extension for **Bonita 7.12.2** version  **community** written in `groovy`
...
Take the built artifact `resourceNameRestAPI-1.0.0-SNAPSHOT.zip` and upload it to your Bonita platform (see https://documentation.bonitasoft.com/bonita/${shortBonitaVersion}/rest-api-extensions#toc7)
